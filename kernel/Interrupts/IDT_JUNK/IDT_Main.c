...
LOUSTATUS SetBasicInterrupts(bool Init){
    ...
    #ifdef __x86_64__
    if(Init){
        set_idt_gate(0,ISR0 , KernelCodeSegment, 0, 0);
        set_idt_gate(1,ISR1 , KernelCodeSegment, 0, 0);
        set_idt_gate(2,ISR2 , KernelCodeSegment, 0, 0);
        set_idt_gate(3,ISR3 , KernelCodeSegment, 0, 0);
        set_idt_gate(4,ISR4 , KernelCodeSegment, 0, 0);
        set_idt_gate(5,ISR5 , KernelCodeSegment, 0, 0);
        set_idt_gate(6,ISR6 , KernelCodeSegment, 0, 0);
        set_idt_gate(7,ISR7 , KernelCodeSegment, 0, 0);
        set_idt_gate(8,ISR8 , KernelCodeSegment, 0, 0);
        set_idt_gate(9,ISR9 , KernelCodeSegment, 0, 0);
        set_idt_gate(10,ISR10 , KernelCodeSegment, 0, 0);
        set_idt_gate(11,ISR11 , KernelCodeSegment, 0, 0);
        set_idt_gate(12,ISR12 , KernelCodeSegment, 0, 0);
        set_idt_gate(13,ISR13 , KernelCodeSegment, 0, 0);
        set_idt_gate(14,ISR14 , KernelCodeSegment, 0, 0);
        set_idt_gate(15,ISR15 , KernelCodeSegment, 0, 0);
        set_idt_gate(16,ISR16 , KernelCodeSegment, 0, 0);
        set_idt_gate(17,ISR17 , KernelCodeSegment, 0, 0);
        set_idt_gate(18,ISR18 , KernelCodeSegment, 0, 0);
        set_idt_gate(19,ISR19 , KernelCodeSegment, 0, 0);
        set_idt_gate(20,ISR20 , KernelCodeSegment, 0, 0);
        set_idt_gate(21,ISR21 , KernelCodeSegment, 0, 0);
        set_idt_gate(22,ISR22 , KernelCodeSegment, 0, 0);
        set_idt_gate(23,ISR23 , KernelCodeSegment, 0, 0);
        set_idt_gate(24,ISR24 , KernelCodeSegment, 0, 0);
        set_idt_gate(25,ISR25 , KernelCodeSegment, 0, 0);
        set_idt_gate(26,ISR26 , KernelCodeSegment, 0, 0);
        set_idt_gate(27,ISR27 , KernelCodeSegment, 0, 0);
        set_idt_gate(28,ISR28 , KernelCodeSegment, 0, 0);
        set_idt_gate(29,ISR29 , KernelCodeSegment, 0, 0);
        set_idt_gate(30,ISR30 , KernelCodeSegment, 0, 0);
        set_idt_gate(31,ISR31 , KernelCodeSegment, 0, 0);

        set_idt_gate(32, ISR32, KernelCodeSegment, 0, 0);
        set_idt_gate(33, ISR33, KernelCodeSegment, 0, 0);
        set_idt_gate(34, ISR34, KernelCodeSegment, 0, 0);
        set_idt_gate(35, ISR35, KernelCodeSegment, 0, 0);
        set_idt_gate(36, ISR36, KernelCodeSegment, 0, 0);
        set_idt_gate(37, ISR37, KernelCodeSegment, 0, 0);
        set_idt_gate(38, ISR38, KernelCodeSegment, 0, 0);
        set_idt_gate(39, ISR39, KernelCodeSegment, 0, 0);
        set_idt_gate(40, ISR40, KernelCodeSegment, 0, 0);
        set_idt_gate(41, ISR41, KernelCodeSegment, 0, 0);
        set_idt_gate(42, ISR42, KernelCodeSegment, 0, 0);
        set_idt_gate(43, ISR43, KernelCodeSegment, 0, 0);
        set_idt_gate(44, ISR44, KernelCodeSegment, 0, 0);
        set_idt_gate(45, ISR45, KernelCodeSegment, 0, 0);
        set_idt_gate(46, ISR46, KernelCodeSegment, 0, 0);
        set_idt_gate(47, ISR47, KernelCodeSegment, 0, 0);
        return 0;
    }
    else{
