...
EXTERN_C const IID IID_IWDFFile;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE RetrieveFileName( 
            /* [annotation][unique][out][string] */ 
             _Out_writes_to_opt_(pFileName ? *pdwFileNameLengthInChars : 0, pFileName ? *pdwFileNameLengthInChars : 0)  PWSTR pFileName,
            /* [annotation][out][in] */ 
...
EXTERN_C const IID IID_IWDFFile2;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE RetrieveCountedFileName( 
            ...
            _Out_writes_to_opt_(pCountedFileName ? *pdwCountedFileNameLengthInChars : 0, pCountedFileName ? *pdwCountedFileNameLengthInChars : 0)  WCHAR *pCountedFileName,
            /* [annotation][out][in] */ 
