...
void isUsb(uint8_t bus, uint8_t slot, uint8_t function) {
	...
	case AdvancedMicroDevices_2:
		...
		//case AMD_M4A89GTD_PRO_USB3_MOTHERBOARD_10438410:
		//case M4A89GTD_PRO_USB3:
		//case GA_880GMA_USB3:
		//case GA_880GMA_USB3_2:
		case AMD_NAVI_22_USB:
		case AMD_NAVI_23_USB:
		case AMD_NAVI_31_USB:
		case THEATER_506_USB:
		case THEATER_506_USB2:
		case THEATER_506_EXTERNAL_USB:
		case THEATER_506_EXTERNAL_USB2:
		case THEATER_506A_USB:
		case THEATER_506A_USB2:
		case THEATER_506A_EXTERNAL_USB:
		case THEATER_506A_EXTERNAL_USB2:
		case ARIEL_USB_3_1_TYPE_C_GEN2_DP_ALT_MODE:
		case ARIEL_USB_3_1_TYPE_A_GEN2_2_PORTS:
		case FAMILY_17H_USB_3_0_HOST_CONTROLLER:
		case USB_3_0_HOST_CONTROLLER:
		case STARSHIP_MATISSE_USB_3_0_HOST_CONTROLLER:
		case MATISSE_USB_3_0_HOST_CONTROLLER:
		case FAMILY_19H_USB4_THUNDERBOLT_PCIE_TUNNEL_1:
		case FAMILY_19H_USB4_THUNDERBOLT_PCIE_TUNNEL_2:
		case PHOENIX_USB4_THUNDERBOLT_NHI_CONTROLLER_1:
		case PHOENIX_USB4_THUNDERBOLT_NHI_CONTROLLER_2:
		case FIREFLIGHT_USB_3_1:
		case FIREFLIGHT_USB_3_1_2:
		case REMBRANDT_USB4_XHCI_CONTROLLER_5:
		case REMBRANDT_USB4_XHCI_CONTROLLER_6:
		case RAVEN_USB_3_1:
		case RAVEN_USB_3_1_2:
		case RAVEN2_USB_3_1:
		case REMBRANDT_USB4_XHCI_CONTROLLER_1:
		case REMBRANDT_USB4_XHCI_CONTROLLER_2:
		case REMBRANDT_USB4_XHCI_CONTROLLER_7:
		case REMBRANDT_USB4_XHCI_CONTROLLER_3:
		case REMBRANDT_USB4_XHCI_CONTROLLER_4:
		case REMBRANDT_USB4_XHCI_CONTROLLER_8:
		case VANGOGH_USB2:
		case REMBRANDT_USB4_THUNDERBOLT_NHI_CONTROLLER_1:
		case REMBRANDT_USB4_THUNDERBOLT_NHI_CONTROLLER_2:
		case RENOIR_USB_3_1:
		case VANGOGH_USB0:
		case VANGOGH_USB1:
		case VANGOGH_SECUSB:
		case PINK_SARDINE_USB4_THUNDERBOLT_NHI_CONTROLLER_1:
		case PINK_SARDINE_USB4_THUNDERBOLT_NHI_CONTROLLER_2:
		//case ASM1042A_USB_3_0_HOST_CONTROLLER:
		case X370_SERIES_CHIPSET_USB_3_1_XHCI_CONTROLLER:
		case X399_SERIES_CHIPSET_USB_3_1_XHCI_CONTROLLER:
		case SERIES_300_CHIPSET_USB_3_1_XHCI_CONTROLLER:
		case SERIES_400_CHIPSET_USB_3_1_XHCI_CONTROLLER:
		case SERIES_500_CHIPSET_USB_3_1_XHCI_CONTROLLER:
		case SERIES_600_CHIPSET_USB_3_2_CONTROLLER:
		case AMD_755_COBRA_USB:
		case AMD_756_VIPER_USB:
		case AMD_766_VIPERPLUS_USB:
		case AMD_768_OPUS_USB:
		case AMD_8111_USB:
		case AMD_8111_USB_EHCI:
		case AMD_8111_USB_OHCI:
		case FCH_USB_OHCI_CONTROLLER_1:
		case FCH_USB_EHCI_CONTROLLER_1:
		case FCH_USB_XHCI_CONTROLLER_1:
		case FCH_USB_XHCI_CONTROLLER_2:
		case FCH_USB_EHCI_CONTROLLER_2:
		case FCH_USB_XHCI_CONTROLLER_3:
