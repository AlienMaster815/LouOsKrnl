...
bool IsAppleMcp89(PPCI_COMMON_CONFIG Config) {
    if (
        (Config->Header.VendorID == 0x10DE) && 
        (Config->Header.DeviceID == 0x0D85) && 
        (Config->Header.u.type0.SubVendorID == 0x106B) &&
