...
typedef volatile struct tagHBA_MEM
{
	...
	uint32_t cap;		// 0x00, Host capability //280
	uint32_t ghc;		// 0x04, Global host control //284
	uint32_t is;		// 0x08, Interrupt status //288
	uint32_t pi;		// 0x0C, Port implemented //292
